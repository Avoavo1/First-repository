...
train_datageon=ImageDataGenerator(rescale=1/255,validation_split=0.2)

train_data=train_datageon.flow_from_directory(
    DATASET_PATH, target_size=(128,128),batch_size=32,class_mode=class_mode, subset='training'
)

val_data = train_datageon.flow_from_directory(
...
print(f"prozent of accuracy: {test_accuracy:.2f}")
